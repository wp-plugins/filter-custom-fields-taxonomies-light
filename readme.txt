...
[CodeCanyon](http://codecanyon.net/item/filter-custom-fields-taxonomies/6964843?ref=websupporter "WordPress Filter Plugin")

More information: [WordPress Filter Custom Fields & Taxonomies](http://profisearchform.com "WordPress Filter" ),
[Video Tutorials](http://profisearchform.com/video "Videos" ),
[Help & FAQ](http://profisearchform.com/help-faq "Filter Custom Fields & Taxonomies Help" )

**Available languages**:
English, German, Serbian (thanks to <a href="http://www.webhostinghub.com">webhostinghub</a>)
...
Please visit our [Filter Custom Fields & Taxonomies Help](http://www.profisearchform.com/help-faq/ "Filter Custom Fields & Taxonomies Help")


== Screenshots ==

1. Choose the custom fields and taxonomies

2. Choose the layout

3. Drag & drop the form elements you want to use

4. Configure the fulltext element

5. Configure the selectbox element
...
*Version 1.02*
New language pack: Serbian (thanks to <a href="http://www.webhostinghub.com">webhostinghub</a>)
...
== Upgrade Notice ==
Before you upgrade, you need to backup your template files, which you will find in the /templates/-folder. They will be overwritten by the update.